...
<body>
    <img src="caramelo.png" alt="avatar de title" srcset="">
    ...
    <div>
            ...
            <p class="badge bg-secondary">Matemática</p>
            <p class="badge bg-secondary">Autodidata</p>
            <p class="badge bg-secondary">Poliglota</p>
    ...
    <main class="container mt-5">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="card">
                    <img src="Engenharia.jpeg" class="card-img-top" alt="Imagem do projeto de biblioteca virtual">
                    <div class="card-body">
            ...
            <div class="col-md-4">
                <div class="card">
                    <img src="Gastronomia.jpeg" class="card-img-top" alt="Imagem do projeto de biblioteca virtual">
                    <div class="card-body">
            ...
            <div class="col-md-4">
                <div class="card">
                    <img src="Programacao.jpeg" class="card-img-top" alt="Imagem do projeto de biblioteca virtual">
                    <div class="card-body">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <img src="Engenharia.jpeg"img-fluid w-100"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <img src="Gastronomia.jpeg" class="img-fluid w-100"
                        alt="Imagem representativa do projeto de uma biblioteca online">
                </div>
                <div class="modal-footer">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <img src="Programacao.jpeg" alt="Projeto 3" class="img-fluid w-100">
                </div>
                <div class="modal-footer">
    ...
    <footer class="container py-5">
        ...
        <div>
            ...
            <a href="https://github.com/PPV142">GitHub</a>
        </div>
        <p class="my-5 text-center">© Copyright 2025. Produzido por Piettro Viola</p>
    </footer>
